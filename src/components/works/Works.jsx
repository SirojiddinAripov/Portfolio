    ...
    return (
        <div className="works" id="JavaScript">
            <div className="text">
                ...
                <input type = "none "style={{ zIndex:"-5", position: "absolute", right: "100%"}} onFocus={() => { id=0; changePic("imagePan2"); }} id="JavaScript1" />
                <input type = "none "style={{ zIndex:"-5", position: "absolute", right: "100%"}} onFocus={() => { id=1; changePic("imagePan2"); }} id="JavaScript2" />
